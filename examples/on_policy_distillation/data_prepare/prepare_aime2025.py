#!/usr/bin/env python3
"""
Prepare math-ai/aime25 (AIME 2025) for OPSD evaluation (or training).

AIME-2025 dataset has 30 competition problems total.
...
Usage:
  ...
  python prepare_aime2025.py --mode eval --num-samples 30 \\
      --output /root/data/aime2025_eval.jsonl --seed 42
...
def main():
    parser = argparse.ArgumentParser(
        description="Prepare AIME-2025 for OPSD evaluation or training.",
    ...
    parser.add_argument("--num-samples", type=int, required=True,
                        help="Number of samples to output (AIME 2025 has 30 total)")
    ...
    print(f"Loading '{AIME2025_REPO}' ...")
    ds = hf.load_dataset(AIME2025_REPO, cache_dir=cache_dir, trust_remote_code=True)
