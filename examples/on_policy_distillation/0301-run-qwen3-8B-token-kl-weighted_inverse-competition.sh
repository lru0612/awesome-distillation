...
# Token-KL-Weighted OPSD on competition math
#
...
CKPT_SAVE_DIR="/root/output/Qwen3-8B_token_kl_weighted_inverse_competition"
CKPT_ARGS=(
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-8B-token-kl-weighted-inverse-competition
