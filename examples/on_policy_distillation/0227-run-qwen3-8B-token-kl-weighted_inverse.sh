...
#   - KL_WEIGHT_MODE=inverse  →  per-token confidence weighting still active
...
CKPT_SAVE_DIR="/root/output/Qwen3-8B_token_kl_weighted"
CKPT_ARGS=(
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-8B-token-kl-weighted-inverse
