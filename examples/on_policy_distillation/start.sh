...
bash examples/on_policy_distillation/0316-run-OLMO3-7B-openthoughts-forwardKL.sh
bash examples/on_policy_distillation/0316-run-OLMO3-7B-openthoughts-jsd.sh
bash examples/on_policy_distillation/0316-run-OLMO3-7B-openthoughts-ReverseKL.sh
bash examples/on_policy_distillation/0316-run-OLMO3-7B-openthoughts-jsd--weighted_inverse.sh