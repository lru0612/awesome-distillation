...
# OPSD (Forward KL) on DAPO-Math-17k + OpenThoughts mixed dataset, with OLMo3-7B
#
# Algorithm: OPSD with pure forward KL loss.
#   --opsd-loss-type forward_kl → KL(p_T ‖ p_S), mode-covering.
...
#
# Usage: bash examples/on_policy_distillation/0316-run-OLMO3-7B-openthoughts-forwardKL.sh
...
CKPT_SAVE_DIR="/root/output/OLMo3-7B_opsd_forwardKL_openthoughts"
CKPT_ARGS=(
...
WANDB_ARGS=(
   ...
   --wandb-group olmo3-7B-opsd-dapo-openthoughts-forwardKL
