...
#
# Algorithm: segmented OPSD with pure forward KL loss (opsd-jsd-beta 1.0).
#   JSD(P,Q) = β·KL(P‖Q) + (1−β)·KL(Q‖P), β=1.0 → pure KL(P‖Q) (forward KL)
# Token-level KL weighting: uniform (no weighting) for both KL and segment dimensions.
#
