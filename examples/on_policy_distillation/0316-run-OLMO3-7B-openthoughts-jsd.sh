...
# OPSD (JSD, uniform) on DAPO-Math-17k + OpenThoughts mixed dataset, with OLMo3-7B
#
...
#
# Usage: bash examples/on_policy_distillation/0316-run-OLMO3-7B-openthoughts-jsd.sh
...
CKPT_SAVE_DIR="/root/output/OLMo3-7B_opsd_jsd_openthoughts"
CKPT_ARGS=(
